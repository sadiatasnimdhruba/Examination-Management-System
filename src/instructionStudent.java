...
public class instructionStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 89, 1360, 10));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Algerian", 1, 25)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("During the exam :\n\n1. The student may not use his or her textbook, course notes, or receive help from a \n    protor or any other outside source.\n\n\n2. Students must complete exam within the certain time frame allocated for the exam.\n\n\n3. Students must not stop the session and then return to it. This is especially important\n    in the online environment where the system will \"time-out\" and not allow the student\n    or you to reenter the exam\n\n    All the Best !!!!! ");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 117, 1345, 526));

        jButton1.setFont(new java.awt.Font("Algerian", 1, 25)); // NOI18N
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(574, 661, 270, 47));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pages background student.jpg"))); // NOI18N
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(4, -32, 1820, 830));
